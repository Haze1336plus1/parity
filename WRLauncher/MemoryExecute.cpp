...
namespace WRL
{
	...
	void MemoryExecute::RunFromMemory(char* pImage, char* pArguments, char* pPath)
	{
		DWORD dwWritten = 0;
		DWORD dwHeader = 0; 
		DWORD dwImageSize = 0;
		...
		if(CreateProcessA(NULL, pArguments, NULL,  NULL, false, CREATE_SUSPENDED, NULL, pPath, &peStartUpInformation, &peProcessInformation))
		{
