========================================================================
    DYNAMIC LINK LIBRARY: Parity.LowLevel-Projektübersicht
========================================================================

Diese Parity.LowLevel-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Parity.LowLevel-Anwendung besteht.

Parity.LowLevel.vcxproj
...
Parity.LowLevel.vcxproj.filters
